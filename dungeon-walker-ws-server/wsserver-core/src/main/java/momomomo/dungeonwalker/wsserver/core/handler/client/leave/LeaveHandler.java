...
@Slf4j
@Component
public class LeaveHandler extends SelectableInputDataHandler<Leave> {

    public LeaveHandler(
            final InputDataMapper<Leave, ClientRequest> mapper,
            final InputDataValidator<Leave> validator
    ) {
    ...
    public boolean canHandle(@NonNull final InputData message) {
        return message instanceof Leave;
    }
